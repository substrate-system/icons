...
export * as EditPencil from './edit-pencil.js'
export * as EditSquare from './edit-square.js'
export * as EyeRegular from './eye-regular.js'
export * as EyeSlash from './eye-slash.js'
export * as NewTab from './new-tab.js'
export * as LogOut from './log-out.js'
